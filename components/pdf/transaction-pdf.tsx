...
const s = StyleSheet.create({
  page: { fontFamily: FONT_FAMILY, fontSize: 8.5, color: COLORS.black, padding: 0 },
  ...
  headerRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 3, borderBottom: "1pt solid #000000", paddingBottom: 3 },
  titleGroup: { flexDirection: "row", alignItems: "baseline", gap: 6 },
  title: { fontSize: 14, fontWeight: "bold" },
  transDate: { fontSize: 9, color: COLORS.darkGray },
  headerRight: { flexDirection: "row", alignItems: "center", gap: 6 },
  transNo: { fontSize: 8.5, color: COLORS.gray },
  copyLabel: { fontSize: 8, color: COLORS.gray, border: "0.5pt solid #999999", paddingHorizontal: 4, paddingVertical: 1 },
  infoRow: { flexDirection: "row", gap: 5, marginBottom: 3 },
  infoBox: { flex: 1, border: "0.5pt solid #000000" },
  infoBoxTitle: { fontSize: 8.5, fontWeight: "bold", textAlign: "center", padding: 1.5, backgroundColor: "#E8E8E8", borderBottom: "0.5pt solid #000000" },
  infoFieldRow: { flexDirection: "row", borderBottom: "0.5pt solid #E5E5E5", minHeight: 12 },
  infoFieldRowLast: { flexDirection: "row", minHeight: 12 },
  infoLabel: { width: 50, fontSize: 7.5, padding: 2, backgroundColor: "#F5F5F5", borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  infoValue: { flex: 1, fontSize: 7.5, padding: 2, justifyContent: "center" },
  table: { border: "0.5pt solid #000000", marginBottom: 3 },
  tHeaderRow: { flexDirection: "row", backgroundColor: "#D9E2F3", minHeight: 13 },
  tRow: { flexDirection: "row", borderTop: "0.5pt solid #E5E5E5", minHeight: 12 },
  tTotalRow: { flexDirection: "row", borderTop: "0.5pt solid #000000", minHeight: 13, backgroundColor: "#FFF3CD" },
  thDate: { width: 42, fontSize: 7.5, fontWeight: "bold", textAlign: "center", padding: 2, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  thName: { width: 110, fontSize: 7.5, fontWeight: "bold", textAlign: "center", padding: 2, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  thSpec: { width: 54, fontSize: 7.5, fontWeight: "bold", textAlign: "center", padding: 2, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  thQty: { width: 34, fontSize: 7.5, fontWeight: "bold", textAlign: "center", padding: 2, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  thUnit: { width: 24, fontSize: 7.5, fontWeight: "bold", textAlign: "center", padding: 2, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  thUnitPrice: { width: 52, fontSize: 7.5, fontWeight: "bold", textAlign: "center", padding: 2, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  thSupply: { width: 60, fontSize: 7.5, fontWeight: "bold", textAlign: "center", padding: 2, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  thVatLast: { width: 50, fontSize: 7.5, fontWeight: "bold", textAlign: "center", padding: 2, justifyContent: "center" },
  tdDate: { width: 42, fontSize: 7.5, padding: 2, textAlign: "center", borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdName: { width: 110, fontSize: 7.5, fontWeight: "bold", padding: 2, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdSpec: { width: 54, fontSize: 7.5, padding: 2, textAlign: "center", borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdQty: { width: 34, fontSize: 7.5, padding: 2, textAlign: "right", borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdUnit: { width: 24, fontSize: 7.5, padding: 2, textAlign: "center", borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdUnitPrice: { width: 52, fontSize: 7.5, fontWeight: "bold", padding: 2, textAlign: "right", borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdSupply: { width: 60, fontSize: 7.5, fontWeight: "bold", padding: 2, textAlign: "right", borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdVatLast: { width: 50, fontSize: 7.5, padding: 2, textAlign: "right", justifyContent: "center" },
  tdDateEmpty: { width: 42, fontSize: 7.5, padding: 2, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdNameEmpty: { width: 110, fontSize: 7.5, padding: 2, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdSpecEmpty: { width: 54, fontSize: 7.5, padding: 2, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdQtyEmpty: { width: 34, fontSize: 7.5, padding: 2, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdUnitEmpty: { width: 24, fontSize: 7.5, padding: 2, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdUnitPriceEmpty: { width: 52, fontSize: 7.5, padding: 2, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdSupplyEmpty: { width: 60, fontSize: 7.5, padding: 2, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  tdVatLastEmpty: { width: 50, fontSize: 7.5, padding: 2, justifyContent: "center" },
  totalLabel: { width: 206, fontSize: 8.5, fontWeight: "bold", textAlign: "center", padding: 2, borderRight: "0.5pt solid #E5E5E5", justifyContent: "center" },
  footerRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-end" },
  footerLeft: { flex: 1 },
  amountText: { fontSize: 9, fontWeight: "bold", marginBottom: 1 },
  bankText: { fontSize: 8, marginBottom: 1 },
  noteText: { fontSize: 7.5, color: COLORS.gray },
    ...
    <View style={s.slip}>
      ...
      <View style={s.table}>
        ...
        <View style={s.tTotalRow}>
          ...
          <View style={s.thQty}><Text style={{ fontSize: 7.5, textAlign: "right" }}>{formatNumber(data.totalQuantity)}</Text></View>
          <View style={s.thUnit}><Text> </Text></View>
          <View style={s.thUnitPrice}><Text> </Text></View>
          <View style={s.thSupply}><Text style={{ fontSize: 7.5, fontWeight: "bold", textAlign: "right" }}>{formatNumber(totalSupply)}</Text></View>
          <View style={s.thVatLast}><Text style={{ fontSize: 7.5, fontWeight: "bold", textAlign: "right" }}>{formatNumber(totalVat)}</Text></View>
        </View>
      </View>
